                    ...
                    children.forEach(function (child) {
                        ...
                        if (child.getAttribute) {
                            ...
                            if (href && media[href]) {
                                ...
                                child.setAttribute('href', 'data:' + media[href].type + ';' + media[href].encoding + ',' + encodeURIComponent(quote(media[href].data)));
                            }

                            // Resolve scripts and images.
                            if (src && media[src]) {
                                child.setAttribute('src', 'data:' + media[src].type + ';' + media[src].encoding + ',' + encodeURIComponent(media[src].data));
                            }

                            // Resolve inline-scripts.
                            for (style in child.style) {
                                if (_typeof(child.style[style]) === _typeof('')) {
                                    // Find the next css rule with an external reference.
